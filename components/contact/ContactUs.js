...
const ContactUs = () => {
    return (
        <div
            id="contact"
            className="max-w-[90%] md:max-w-[70%] xl:max-w-[1200px] mx-auto mt-10"
        >
            ...
            <div className="flex flex-col md:flex-row gap-10 lg:gap-28">
                ...
                <div>
                    <div className="mb-8">
                        ...
                        <p className="py-4">
                            Our call center is active 24/7, you can reach us
                            anytime
                        </p>
                        <div className="flex">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="py-4">
                            With our hospitable service for customers, your are
                            always welcome
                        </p>
                        <div className="flex">
                            <div className="w-9 h-9 bg-yellow-200 rounded-md grid place-items-center mr-2">
